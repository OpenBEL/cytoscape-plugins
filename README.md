KAM Navigator Cytoscape Plugin V0.8
===================================

KAM Navigator is a [Cytoscape](http://www.cytoscape.org/) plugin that allows licensed [BEL Framework](http://www.openbel.org/) users to query, visualize, and 
